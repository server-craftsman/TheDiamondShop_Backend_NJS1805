  ...
  try {
    ...
    let result = await pool.request().input("id", sql.Int, id).query(`
          SELECT
            ...
            a.PhoneNumber,
            o.OrderDate,
            d.DiamondOrigin AS Diamond,
            d.Clarity AS Diamond,
            d.Cut AS Diamond,
            d.Price AS Diamond,
            d.StockNumber AS Diamond,
            d.Color AS Diamond,
            d.CaratWeight AS Diamond,
            d.Shape AS Diamond,
            dr.RingStyle AS DiamondRings,
            dr.NameRings AS DiamondRings,
            dr.Category AS DiamondRings,
            dr.BrandName AS DiamondRings,
            dr.Gender AS DiamondRings,
            dr.Description AS DiamondRings,
            br.NameBridal AS Bridal,
            br.BridalStyle AS Bridal,
            br.Category AS Bridal,
            br.BrandName AS Bridal,
            br.SettingType AS Bridal,
            br.Gender AS Bridal,
            br.Weight AS Bridal,
            br.CenterDiamond AS Bridal,
            br.Description AS Bridal,
            t.NameTimepieces AS DiamondTimepieces,
            t.TimepiecesStyle AS DiamondTimepieces,
            t.Collection AS DiamondTimepieces,
            t.WaterResistance AS DiamondTimepieces,
            t.CrystalType AS DiamondTimepieces,
            t.BraceletMaterial AS DiamondTimepieces,
            t.CaseSize AS DiamondTimepieces,
            t.Movement AS DiamondTimepieces,
            t.Gender AS DiamondTimepieces,
            t.Description AS DiamondTimepieces,
            t.Category AS DiamondTimepieces,
            t.BrandName AS DiamondTimepieces,
            t.Price AS DiamondTimepieces,
            od.MaterialID,
            od.RingSizeID,
			      rs.RingSize,
			      m.MaterialName,
